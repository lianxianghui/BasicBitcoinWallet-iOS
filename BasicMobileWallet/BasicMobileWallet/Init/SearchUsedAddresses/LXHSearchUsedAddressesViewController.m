// LXHSearchUsedAddressesViewController.m
// BasicWallet
//
//  Created by lianxianghui on 20-01-14
//  Copyright © 2020年 lianxianghui. All rights reserved.

#import "LXHSearchUsedAddressesViewController.h"
#import "Masonry.h"
...
@interface LXHSearchUsedAddressesViewController()
@property (nonatomic) LXHSearchUsedAddressesView *contentView;
@property (nonatomic) LXHSearchUsedAddressesViewModel *viewModel;
@end

@implementation LXHSearchUsedAddressesViewController
...
- (void)viewDidLoad {
    ...
    self.contentView = [[LXHSearchUsedAddressesView alloc] init];
