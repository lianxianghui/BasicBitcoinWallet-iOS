...
@interface LXHAddressListView()
@end

@implementation LXHAddressListView
...
- (UILabel *)title {
    if (!_title) {
        ...
        NSAttributedString *text = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"本地地址列表", nil) attributes:textAttributes];
