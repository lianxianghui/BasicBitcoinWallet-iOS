// LXHSmallSizeTextRightIconCell.m
// BasicWallet
//
...
@interface LXHSmallSizeTextRightIconCell()
@end

@implementation LXHSmallSizeTextRightIconCell
...
- (UILabel *)text {
    if (!_text) {
        ...
        NSAttributedString *text = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"账户扩展公钥(xpub)", nil) attributes:textAttributes];
