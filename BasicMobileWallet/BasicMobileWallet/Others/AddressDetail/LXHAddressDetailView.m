...
@interface LXHAddressDetailView()
@end

@implementation LXHAddressDetailView
...
- (UILabel *)title {
    if (!_title) {
        ...
        NSAttributedString *text = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"本地地址详情", nil) attributes:textAttributes];
