...
@interface LXHTitleCell1()
@end

@implementation LXHTitleCell1
...
- (UILabel *)title {
    if (!_title) {
        ...
        NSAttributedString *text = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"输入 0.00075646BTC", nil) attributes:textAttributes];
