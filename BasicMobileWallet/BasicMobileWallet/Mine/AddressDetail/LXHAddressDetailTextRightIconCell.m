// LXHAddressDetailTextRightIconCell.m
// BasicWallet
//
...
@interface LXHAddressDetailTextRightIconCell()
@end

@implementation LXHAddressDetailTextRightIconCell
...
- (UIImageView *)disclosureIndicator {
    if (!_disclosureIndicator) {
        ...
        _disclosureIndicator.image = [UIImage imageNamed:@"mine_addressdetail_disclosure_indicator"];
    }
