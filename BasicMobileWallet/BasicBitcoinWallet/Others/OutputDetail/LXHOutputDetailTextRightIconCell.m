// LXHOutputDetailTextRightIconCell.m
// BasicWallet
//
...
@interface LXHOutputDetailTextRightIconCell()
@end

@implementation LXHOutputDetailTextRightIconCell
...
- (UILabel *)text {
    if (!_text) {
        ...
        NSAttributedString *text = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"所在交易", nil) attributes:textAttributes];
