...
@interface LXHTwoColumnTextCell()
@end

@implementation LXHTwoColumnTextCell
...
- (UILabel *)title {
    if (!_title) {
        ...
        [textAttributes setObject:paragraphStyle forKey:NSParagraphStyleAttributeName];
        NSAttributedString *text = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"版本号", nil) attributes:textAttributes];
