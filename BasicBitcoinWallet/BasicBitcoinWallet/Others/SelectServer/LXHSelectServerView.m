// LXHSelectServerView.m
// BasicWallet
//
//  Created by lianxianghui on 20-09-18
...
@interface LXHSelectServerView()
@end

@implementation LXHSelectServerView
...
- (UILabel *)title {
    if (!_title) {
        ...
        NSAttributedString *text = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"选择服务节点", nil) attributes:textAttributes];
