...
@interface LXHCheckTextCell()
@end

@implementation LXHCheckTextCell
...
- (UILabel *)title {
    if (!_title) {
        ...
        NSAttributedString *text = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"testnet-api.smartbit.com.au", nil) attributes:textAttributes];
