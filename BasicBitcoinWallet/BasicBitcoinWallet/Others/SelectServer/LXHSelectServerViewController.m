// LXHSelectServerViewController.m
// BasicWallet
//
...
- (void)viewDidLoad {
    ...
    self.contentView = [[LXHSelectServerView alloc] init];
...
- (NSInteger)tableView:(UITableView *)tableView viewTagAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([cellType isEqualToString:@"LXHCheckTextCell"])
        return 100;
    return -1;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([cellType isEqualToString:@"LXHCheckTextCell"]) {
        LXHCheckTextCell *cellView = (LXHCheckTextCell *)view;
